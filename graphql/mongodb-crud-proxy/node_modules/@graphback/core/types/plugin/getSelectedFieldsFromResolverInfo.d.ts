 ...
 */
export declare const getSelectedFieldsFromResolverInfo: (info: GraphQLResolveInfo, model: ModelDefinition, path?: string) => string[];
/**
 ...
 * @param path - the root path to start field resolution from
 */
export declare const getResolverInfoFieldsList: (info: GraphQLResolveInfo, path?: string) => string[];
